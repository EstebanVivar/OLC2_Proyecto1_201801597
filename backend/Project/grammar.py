...
from Expresiones.Longitud import Longitud
...
def p_IMPRIMIR_SALTO(t):
    ...
    t[0] = ImprimirLn(t[3], t.lineno(1), ENCONTRAR_COL(input, t.slice[1]))
...
def p_ACCESO_STRUCT(t):
    ...
    t[0] = AccesoStruct(t[1], t[3], t.lineno(
...
def p_RETURN(t):
    ...
    t[0] = Return(t[2], t.lineno(1), ENCONTRAR_COL(input, t.slice[1]))
...
def p_EXPRESION_LONGITUD(t):
    ...
    t[0] = Longitud(t[3], t.lineno(2), ENCONTRAR_COL(input, t.slice[4]))
